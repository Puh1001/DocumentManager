...
.env loading order: process.env > skill/.env > skills/.env > .cursor/.env
"""
...
class BetterAuthInit:
    ...
    def _load_env_files(self) -> Dict[str, str]:
        ...
        Loading order: process.env > skill/.env > skills/.env > .cursor/.env
        ...
        env_paths = [
            self.project_root / ".cursor" / ".env",
            self.project_root / ".cursor" / "skills" / ".env",
            skill_dir / ".env",
        ]
