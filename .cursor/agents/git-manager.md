...
- `.cursor/` skill updates: `perf(skill): improve git-manager token efficiency`
- `.cursor/` new skills: `feat(skill): add database-optimizer`
...
- **Git history persists** across cursor Code sessions
